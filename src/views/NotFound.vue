...
<template>
  <div class="min-h-screen flex items-center justify-center bg-ojen-bg text-center px-4">
    <div>
      <p class="text-6xl font-bold text-ojen-gold mb-2">{{ locale.t('notFound.title') }}</p>
